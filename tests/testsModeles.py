...
phrase = "My grandmother is dead"
print(phrase)
vector = stringToVect(phrase)
prediction=model.predict_proba(vector.reshape(1,-1))[0]
print("model prediction1 : ",np.around(prediction,decimals=2))

phrase = "\"My grandmother is dead \""
print(phrase)
vector2 = stringToVect(phrase)
prediction=model.predict_proba(vector2.reshape(1,-1))[0]
print("model prediction2 : ",np.around(prediction,decimals=2))
